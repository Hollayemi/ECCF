			...
			<div class="row">
				<div class="col-md-3 col-md-push-8 animate-box">
					...
					<ul class="contact-info">
						<li><i class="icon-location4"></i>Adekunle Ajasin University Akungba Akoko</li>
						<li><i class="icon-phone3"></i>+ 08147702684</li>
						<li><i class="icon-location3"></i><a href="#">stephanyemmitty@gmail.com</a></li>
						<li><i class="icon-globe2"></i><a href="#">www.ECCF.com</a></li>
					</ul>
				</div>
